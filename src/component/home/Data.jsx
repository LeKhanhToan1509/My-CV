function Data() {
    return ( 
        <div className="home__data">
            <h1 className="home__title">Toan LK
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">
                I'm a student in PTIT, and this website is my first Project that I created !
            </p>
            <a href="#contact" className="button button--flex" style={{marginTop: '1rem'}}>
                Say Hello
                <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
